...
public class InfoEstacion extends JPanel implements InfoEstacionInterface {
	 ...
	 * Create the panel.
	 */
	protected InfoEstacion() {}
	public InfoEstacion(Estacion e) {
		setLayout(new MigLayout("", "[][grow]", "[][][][][][]"));
		
		JLabel lblNewLabel = new JLabel("ID");
		add(lblNewLabel, "cell 0 0,alignx trailing");
		
		textField = new JTextField(e.getId());
		...
		add(textField_1, "cell 1 1,alignx left");
		...
		add(textField_2, "cell 1 2,alignx left");
		...
		add(textField_3, "cell 1 3,alignx left");
		...
		add(textField_4, "flowx,cell 1 4,alignx left");
		...
		chckbxNewCheckBox.addActionListener(event -> {
			textField_4.setText((chckbxNewCheckBox.isSelected())? "OPERATIVA" : "EN_MANTENIMIENTO");
		});
		add(chckbxNewCheckBox, "cell 1 4");
		...
		add(textField_5, "cell 1 5,alignx left");
